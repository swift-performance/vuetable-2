...
export default {
  ...
  methods: {
    ...
    onRowEnter (dataItem, event) {
      this.$emit(this.eventPrefix + 'row-enter', dataItem, event)
    },
    onRowLeave (dataItem, event) {
      this.$emit(this.eventPrefix + 'row-leave', dataItem, event)
    },
